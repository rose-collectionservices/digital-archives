...
* Document processing steps and collection needs
   ...
   * Create <a href="https://emory.sharepoint.com/:x:/r/sites/EUVRoseLibrary/Shared%20Documents/Digital%20Collections/Transfer%20and%20processing/DigitalArchives_MediaLog_Tier1Processing.xlsx?d=wdf9842da4bcb4997b1da1899ab188d4e&csf=1&web=1&e=AQ67Fv">accession log</a> with one row for each carrier or file transfer/batch. If the accession or collection contains very few carriers/batches, a .txt readme or additional notes in the accession record may be sufficient.
   * Create a [digital processing plan](https://emory.sharepoint.com/:w:/r/sites/EUVRoseLibrary/_layouts/15/Doc.aspx?sourcedoc=%7B4DD5FA40-B31C-4027-8540-20650E38DCE4%7D&file=DA_processingPlan_2017.docx&action=default&mobileredirect=true) (or a .txt readme file for small or simple processing projects if desired) to document any work beyond Tier 1. (High-level or summary information about Tier 1 work that can't be captured in the accession log can be recorded in the ArchivesSpace accession record.)
...
* Transfer and ingest content
   ...
   * Determine which preservation repository the content will house the content. As of 2025, most newly accessioned content will go into LIBSAFE Go. Content from collections that already have born-digital material in The Keep should go into The Keep so the collections are split; however, it is likely all Keep disk images will migrate to LIBSAFE Go in 2026, so new ingest to The Keep will stop.
