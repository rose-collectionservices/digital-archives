...
1. Extent: Add MB/GB volume and number of files to container summary, following examples in [CS Manual 6.1.18](https://github.com/rose-collectionservices/collection-services-manual/tree/master/06-DESCRIPTION#6117-processing-information).
...
2. Summary: Make sure existing description encompasses the born-digital material; add more if needed. It is usually not necessary to call out born-digital material specifically in the summary if it can be accurately described in a format-agnostic way (e.g., "correspondence" or "business records"), but when the digital content is substantial and its format is important to note, add “and born-digital material” to the summary list of materials.
3. Restrictions on access: Add appropriate collection-level note. File-level notes might also be appropriate for some AOs. See [CS Manual 6.1.18.2](https://github.com/rose-collectionservices/collection-services-manual/tree/master/06-DESCRIPTION#61182-physical-access) for required text and optional additions.
4. Appraisal note (if applicable): See [CS Manual 6.1.16](https://github.com/rose-collectionservices/collection-services-manual/tree/master/06-DESCRIPTION#6116-appraisal-note) for examples.
5. Processing note: Follow examples in [CS Manual 6.1.17](https://github.com/rose-collectionservices/collection-services-manual/tree/master/06-DESCRIPTION#6117-processing-information).
...
9. Other finding aids: Link to TreeSize report using language in [CS Manual 6.1.24](https://github.com/rose-collectionservices/collection-services-manual/tree/master/06-DESCRIPTION#6124-other-finding-aids). [Not yet implemented—waiting for confirmation on file hosting location.] 
